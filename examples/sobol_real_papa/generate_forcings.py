"""Extract forcings for Station Papa Sobol experiment from real SEAPODYM data.

Reads the aggregated 2D PHY Zarr and extracts a 20x20 degree domain around
Station Papa (50N, 145W = 215E), time subset 2000-2004 (60 monthly steps).
...
Usage:
    uv run python examples/sobol_real_pacific/generate_forcings.py
"""
...
# =============================================================================
LAT_RANGE = (40.5, 59.5)
LON_RANGE = (-154.5, -135.5)  # 205.5E-224.5E in -180/180 convention
...
def main():
    print("Extracting Station Papa forcings from real SEAPODYM data...")
    ...
    out = xr.Dataset(
        ...
        attrs={
            "title": "Station Papa forcings from NP-ERA5-NFIX SEAPODYM 2D PHY",
