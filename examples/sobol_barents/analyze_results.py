"""Analyze Sobol results for Barents Sea and produce summary figure.
...
Usage:
    uv run python examples/sobol_barents/analyze_results.py
"""
...
def plot_mean_indices(results, qoi_names):
    ...
    fig.suptitle(
        f"Sobol Sensitivity — Barents Sea (N={N_SAMPLES}, mean over {N_POINTS} points)",
...
def main():
    ...
    print("Analyzing Sobol results for Barents Sea...")
