"""Sobol sensitivity analysis on Barents Sea real SEAPODYM data.
...
Cold Arctic waters: SST ~0 to 12C.
...
Usage:
    uv run python examples/sobol_barents/run_sobol.py
"""
...
def main():
    logger.info("=" * 70)
    logger.info("SOBOL SENSITIVITY — Barents Sea (real data, 20x20, 30 cohorts)")
    logger.info("=" * 70)
