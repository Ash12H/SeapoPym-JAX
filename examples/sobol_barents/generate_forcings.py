"""Extract forcings for Barents Sea Sobol experiment from real SEAPODYM data.

Reads the aggregated 2D PHY Zarr and extracts a 20x20 degree domain around
Barents Sea (75N, 40E), time subset 2000-2004 (60 monthly steps).
...
Usage:
    uv run python examples/sobol_barents/generate_forcings.py
"""
...
# =============================================================================
# Domain — 20x20 degrees around Barents Sea (75N, 40E)
# =============================================================================
LAT_RANGE = (65.5, 84.5)
LON_RANGE = (30.5, 49.5)
...
def main():
    print("Extracting Barents Sea forcings from real SEAPODYM data...")
    ...
    out = xr.Dataset(
        ...
        attrs={
            "title": "Barents Sea forcings from NP-ERA5-NFIX SEAPODYM 2D PHY",
