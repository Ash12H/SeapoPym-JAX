"""Analyze Sobol results for Svalbard and produce summary figure.
...
Usage:
    uv run python examples/sobol_real_svalbard/analyze_results.py
"""
...
def plot_mean_indices(results, qoi_names):
    ...
    fig.suptitle(
        f"Sobol Sensitivity — Svalbard (N={N_SAMPLES}, mean over {N_POINTS} points)",
...
def main():
    ...
    print("Analyzing Sobol results for Svalbard...")
