"""Optimization Comparison for LMTL 0D Model (Noisy Observations).
...
with 30% Gaussian noise added to observations.
...
PLOT_FILE = "examples/images/04b_noise_optimization_comparison_lmtl_0d.png"
