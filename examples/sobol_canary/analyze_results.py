"""Analyze Sobol results for Canary and produce summary figure.
...
Usage:
    uv run python examples/sobol_canary/analyze_results.py
"""
...
def plot_mean_indices(results, qoi_names):
    ...
    fig.suptitle(
        f"Sobol Sensitivity — Canary (N={N_SAMPLES}, mean over {N_POINTS} points)",
...
def main():
    ...
    print("Analyzing Sobol results for Canary...")
