"""Extract forcings for Canary Sobol experiment from real SEAPODYM data.

Reads the aggregated 2D PHY Zarr and extracts a 20x20 degree domain around
Canary (30N, 13W = 347E), time subset 2000-2004 (60 monthly steps).
...
Usage:
    uv run python examples/sobol_canary/generate_forcings.py
"""
...
def main():
    print("Extracting Canary forcings from real SEAPODYM data...")
    ...
    out = xr.Dataset(
        ...
        attrs={
            "title": "Canary forcings from NP-ERA5-NFIX SEAPODYM 2D PHY",
