"""Sobol sensitivity analysis on Canary real SEAPODYM data.
...
Domain: 20x20 degrees around Canary (30N, 13W = 347E)
Subtropical/upwelling waters: SST ~15 to 27C.
...
Usage:
    uv run python examples/sobol_canary/run_sobol.py
"""
...
def main():
    logger.info("=" * 70)
    logger.info("SOBOL SENSITIVITY — Canary (real data, 20x20, 30 cohorts)")
    logger.info("=" * 70)
