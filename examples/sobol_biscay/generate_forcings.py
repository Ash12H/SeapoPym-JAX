"""Extract forcings for Bay of Biscay Sobol experiment from real SEAPODYM data.

Reads the aggregated 2D PHY Zarr and extracts a 20x20 degree domain around
Bay of Biscay (45.5N, 4W), time subset 2000-2004 (60 monthly steps).
...
Usage:
    uv run python examples/sobol_biscay/generate_forcings.py
"""
...
def main():
    print("Extracting Bay of Biscay forcings from real SEAPODYM data...")
    ...
    # Load and subset — no longitude conversion needed (crosses prime meridian)
    ...
    out = xr.Dataset(
        ...
        attrs={
            "title": "Bay of Biscay forcings from NP-ERA5-NFIX SEAPODYM 2D PHY",
