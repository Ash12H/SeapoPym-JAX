"""Analyze Sobol results for Bay of Biscay and produce summary figure.
...
Usage:
    uv run python examples/sobol_biscay/analyze_results.py
"""
...
def plot_mean_indices(results, qoi_names):
    ...
    fig.suptitle(
        f"Sobol Sensitivity — Bay of Biscay (N={N_SAMPLES}, mean over {N_POINTS} points)",
...
def main():
    ...
    print("Analyzing Sobol results for Bay of Biscay...")
