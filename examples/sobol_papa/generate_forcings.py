...
Station PAPA (50N, 132W = 228E), time subset 2000-2004 (60 monthly steps).
...
Usage:
    uv run python examples/sobol_papa/generate_forcings.py
"""
...
# =============================================================================
# Domain — 20x20 degrees around Station PAPA (50N, 132W = 228E)
# =============================================================================
LAT_RANGE = (40.5, 59.5)
LON_RANGE = (-141.5, -122.5)
