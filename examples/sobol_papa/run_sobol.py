...
Temperate North Pacific waters: SST ~4 to 20C.
...
Usage:
    uv run python examples/sobol_papa/run_sobol.py
"""
...
def main():
    logger.info("=" * 70)
    logger.info("SOBOL SENSITIVITY — PAPA (real data, 20x20, 30 cohorts)")
    logger.info("=" * 70)
