"""Sobol sensitivity analysis on Station BATS real SEAPODYM data.
...
Subtropical Atlantic waters: SST ~18 to 30C.
...
Usage:
    uv run python examples/sobol_bats/run_sobol.py
"""
...
def main():
    logger.info("=" * 70)
    logger.info("SOBOL SENSITIVITY — BATS (real data, 20x20, 30 cohorts)")
    logger.info("=" * 70)
